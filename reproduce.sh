...
BUILD_TIME=""
KSU="none"
SUSFS=0; LZ4=0; LZ4KD=0; SHOWALL=0; ZRAMWB=0; DROIDSPACES="false"; BBG=0; CVE=0; BETTERNET=0; BBR=0; KPM=0; REKERNEL=0
SUFFIX=""; CLEAN=0
...
[ "$ZRAMWB" != "1" ] && ./scripts/config --file .config -d CONFIG_ZRAM_WRITEBACK -d CONFIG_ZRAM_MEMORY_TRACKING
